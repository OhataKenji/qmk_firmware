...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT(
      ...
      KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_LBRC, MIDI,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_ENT ,
  ...
  [_MIDI] =  LAYOUT(
      KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                     KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,
      MI_OC0, MI_OC1, MI_OC2, MI_OC3, MI_OC4, MI_OC5,                   MI_Ds1, MI_E1, MI_F1, MI_Fs1, MI_G1, MI_Gs1,
      _______, _______, _______, _______, _______, _______,                   MI_As, MI_B, MI_C1, MI_Cs1, MI_D1, MI_Ds1,
      _______, _______, _______, _______, _______, _______, _______, _______, MI_F, MI_Fs, MI_G, MI_Gs, MI_A, MI_As,
      _______, _______, _______, _______, _______, _______, _______, _______, MI_C, MI_Cs, MI_D, MI_Ds, MI_E, MI_F 
      )
