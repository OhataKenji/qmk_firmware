...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust| Esc  | Alt  | GUI  | EISU |Lower |Space |Space |Raise | KANA | GUI  | Alt  | Shift|HHKB  |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT(
      ...
      ADJUST,  KC_ESC,  KC_LALT, KC_LGUI, KC_BSPC, LOWER,   KC_SPC,  KC_SPC,  RAISE,   KC_ENT,  KC_RGUI, KC_RALT, KC_RSFT, HHKB_FN
    ),
   ...
   */
  [_HHKB] = LAYOUT(
      KC_ESC,  _______, _______, _______, _______, _______,                   _______, _______, _______, _______, KC_INS,  KC_DEL,
      _______, _______, _______, _______, _______, _______,                   _______, KC_PSCR, KC_SCRL, KC_PAUS, KC_UP,   _______,
      _______, _______, _______, _______, _______, _______,                   _______, KC_HOME, KC_PGUP, KC_LEFT, KC_RGHT, _______,
      _______, _______, _______, _______, _______, _______, KC_LCBR, KC_RCBR, _______, _______, KC_END,  KC_PGDN, KC_DOWN, _______,
   ...
   */
  [_LOWER] = LAYOUT(
      EISU,    _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, _______,
   ...
   */
  [_RAISE] = LAYOUT(
      KANA,    _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, KC_BSPC,
      KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,                      KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_DEL,
...
const uint16_t PROGMEM encoder_map[][NUM_ENCODERS][NUM_DIRECTIONS] = {
    ...
    [_HHKB] =   { ENCODER_CCW_CW(KC_MS_WH_UP, KC_MS_WH_DOWN),    ENCODER_CCW_CW(KC_VOLD, KC_VOLU)  },
